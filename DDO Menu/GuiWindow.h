...
constexpr const char* AUTHOR_INFO = "Created by font9999 On ";
constexpr const char* WINDOW_NAME = "DDO Menu ";
constexpr const char* MODULE_NAME = nullptr;
constexpr DWORD MAJOR_VERSION = 0;
constexpr DWORD MINOR_VERSION = 0;
constexpr DWORD REVISION_VERSION = 1;
